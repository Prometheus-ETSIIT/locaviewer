...
java -cp ../../../Libs/gstreamer-java/gstreamer-java-1.6.jar:../../../Libs/JNA/jna-4.1.0.jar:../../../Libs/JNA/jna-platform-4.1.0.jar:../../../DDStheus/dist/DDStheus.jar:$NDDSHOME/class/nddsjavad.jar:./ gui.InicioSesion $@
