...
public class TopicoControlDinamico extends TopicoControl {
    private final TopicDescription topico;
    
    public TopicoControlDinamico(final String partName) {
        super(partName);
        
        this.topico = this.getParticipante().lookup_topicdescription("DominioLocaviewer::ChildDataTopic");
    }
