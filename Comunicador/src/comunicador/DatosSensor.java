...
class DatosSensor {
     ...
     */
    public DatosSensor(String id, double posX, double posY, String ninoId,
            int intensidad) {
        this.id         = id;
     ...
     */
    public DatosSensor(String id, Par<Double, Double> sensorPos, String ninoId,
            int intensidad) {
        this.id         = id;
    ...
    public DatosSensor(String mensaje) {
        ...
        this.id  = fields[0];
        double posX = Double.parseDouble(fields[1]);
        double posY = Double.parseDouble(fields[2]);
        this.sensorPos  = new Par<>(posX, posY);
        this.ninoId     = fields[3];
        this.intensidad = Integer.parseInt(fields[4]);
        this.creacion   = Long.parseLong(fields[5]);
    }
    ...
    public String toString() {
        return id + " " + sensorPos.getPrimero() + " " + sensorPos.getSegundo() 
                + " " + ninoId + " " + intensidad + " " + creacion;
    }
